...
def state():
    ...
    return {
        ...
        "ideas": [
            ...
            {"name": "Affiliate Leaderboard", "status": "📋 RESEARCHED", "desc": "Referral programs ranked: Axiom #1 by volume (55% share, 10% off ref), GMGN 25% commission (we USE it), Terminal/Padre up to 35% cashback, Trojan 10% lifetime 5-level, Maestro 25% sticky, Sui Sniper 35% multi-level, BONKbot 30/20/10. BullX SHUT DOWN Jun 2026.", "owner": "plan"},
